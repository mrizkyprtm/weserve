      ...
      <div class="flex items-center">
        <div class="flex-1 flex flex-col gap-10">
          ...
          <div id="hero-btn" class="flex items-center">
            <button class="px-10 py-4 bg-[#640EF1] rounded-full text-white font-bold">
              Try Free Trial
            </button>
            <button class="px-10 py-4 font-semibold text-[#640EF1] flex items-center gap-1">
              <svg
                width="25"
                height="24"
                viewBox="0 0 25 24"
