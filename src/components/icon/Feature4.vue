<template>
  <svg width="47" height="46" viewBox="0 0 47 46" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 11.9792V15.8125" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
    <path
    ...
    <path
      ...
      stroke-linejoin="round"
    />
    <path d="M12 30.6667V34.5" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
    <path
      ...
      stroke-linejoin="round"
    />
    <path d="M27.3333 13.8958H35" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
    <path d="M4.33334 23H42.6667" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
    <path
