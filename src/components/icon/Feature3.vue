<template>
  <svg width="47" height="46" viewBox="0 0 47 46" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M13.6867 34.7875V30.82" stroke-width="3" stroke-linecap="round" />
    <path d="M23.5 34.7875V26.8525" stroke-width="3" stroke-linecap="round" />
    <path d="M33.3133 34.7875V22.8658" stroke-width="3" stroke-linecap="round" />
    <path
